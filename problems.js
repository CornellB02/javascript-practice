...
console.log(doubler([9,7,67,8,3.9098]))
...
console.log(wordWithinArray("hello", ["yes", "no", "hello", "goodbye"]))
...
function echo(str) {
    ...
    return str.toUpperCase() + "..." + str.slice(0,str.length - 1).toUpperCase() + str.slice(3).toLowerCase() + "..." + str.toLowerCase()

};

console.log(echo("hype"))
